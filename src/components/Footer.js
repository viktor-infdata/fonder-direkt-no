  ...
  <React.Fragment>
      ...
      <div className="container">
        <div className="columns">
          ...
          <div className="column is-6-desktop">
            ...
            <p>
              Fonder Direkt er en plattform som produseres av Nyhetsbyrån
              Direkts fondsredaksjon der du kan finne informasjon, lese nyheter
              og ta del i kommunikasjon om fond.
            </p>
          </div>
          <div className="column is-3-desktop">
    ...
    >
      <p className="is-size-7 pr-4">
        På dette nettstedet bruker vi informasjonskapsler for å forbedre
        funksjonaliteten for deg som bruker.{' '}
      </p>
    </CookieConsent>
  </React.Fragment>
)
