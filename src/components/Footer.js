    ...
    <React.Fragment>
        <footer className="footer">
            <div className="container">
                <div className="columns">
                    ...
                    <div className="column is-3-desktop">
                        <h4 className="is-size-5">KONTAKT OSS</h4>
        ...
        <CookieConsent
            ...
            <p className="is-size-7 pr-4">
                På dette nettstedet bruker vi informasjonskapsler for å forbedre funksjonaliteten for deg som bruker.  {" "}
            </p>
        </CookieConsent>
    </React.Fragment>
  )
