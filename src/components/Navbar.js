          ...
          <div className="container">
            ...
            <div className={"navbar-menu " + (this.state.navbarOpen ? 'is-active' : '')}>
              <div className="navbar-start">
                ...
                <Link getProps={isPartiallyActive}  to="/fd-akademi">
                  <svg role="img" viewBox="0 0 24 24" className="is-fd-akademi" xmlns="http://www.w3.org/2000/svg"><title>FD Akademi</title><path d="M0 0h24v24H0z" fill="none"/><path d="M5 13.18v4L12 21l7-3.82v-4L12 17l-7-3.82zM12 3L1 9l11 6 9-4.91V17h2V9L12 3z"/></svg>
                  FD AKADEMI
                </Link>
                <Link getProps={isPartiallyActive}  to="/tagger">
                  TAGGER
                </Link>
              </div>
              <div className="navbar-end">
                ...
                <SearchModal />
                <OutboundLink href="https://twitter.com/fonder_direkt" className="navbar-item is-twitter" target="_blank" rel="noopener noreferrer">
                  ...
                  <span className="is-hidden-desktop">TWITTER</span>
                </OutboundLink>
                <OutboundLink href="https://www.facebook.com/groups/FonderDirekt/" className="navbar-item is-facebook" target="_blank" rel="noopener noreferrer">
                ...
                <OutboundLink href="https://www.linkedin.com/company/fonderdirekt" className="navbar-item is-linkedin" target="_blank" rel="noopener noreferrer">
                ...
                <OutboundLink href="https://www.soundcloud.com/fonderdirekt" className="navbar-item is-soundcloud" target="_blank" rel="noopener noreferrer">
                  ...
                  <span className="sr-only sr-only-focusable">SoundCloud</span>
                  <span className="is-hidden-desktop">SOUNDCLOUD</span>
                </OutboundLink>
              </div>
            </div>
          </div>
