                ...
                <div className="column is-10 is-feature">
                  <div className="columns is-centered is-desktop">
                    <div className="column is-10-desktop is-12-tablet">
                      ...
                      <p>
                        <strong>
                          Tjenesten Fonder Direkt er produsert av Nyhetsbyrån
                          Direkts fondsredaksjon, som er frikoblet fra Direkts
                          øvrige redaksjon. Materialet kan vara finansiert og
                          produsert etter avtale med en ekstern part, og i så
                          tilfelle markert på "Oppdragsartikkel" over rubrikken.
                        </strong>
                      </p>
                      <hr />
                      {tags && tags.length ? (
          ...
          <div className="container content">
            <div className="columns is-centered">
              <div className="column is-8">
                <h5 className="is-size-6 mb-2 has-text-grey">
                  <time dateTime={date}>{date}</time>
                  {sponsored === true && <span> &bull; OPPDRAGSARTIKKEL</span>}
                </h5>
                <h1 className="title is-size-3 mt-0">{title}</h1>
                <PostContent content={content} />
                <hr />
                <p>
                  <strong>
                    Tjenesten Fonder Direkt er produsert av Nyhetsbyrån Direkts
                    fondsredaksjon, som er frikoblet fra Direkts øvrige
                    redaksjon. Materialet kan vara finansiert og produsert etter
                    avtale med en ekstern part, og i så tilfelle markert på
                    "Oppdragsartikkel" over rubrikken.
                  </strong>
                </p>
                <hr />
                {tags && tags.length ? (
