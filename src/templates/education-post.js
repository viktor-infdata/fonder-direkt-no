                  ...
                  <h5 className="is-size-6 mb-2 has-text-grey">
                    ...
                    {soundCloudId != null &&
                        <React.Fragment>
                          ...
                          {english !== true &&
                            <h5 className="is-size-5">FD Akademi finne også som podcast</h5>
                          }
                    ...
                    {english !== true &&
                      <React.Fragment><p><strong>FD Akademi tilbyr utdanning og innsikt i finansielle termer, temaer og temaer relatert til fond og andre finansielle investeringsprodukter. FD Akademi ønsker å bryte barrierer når det gjelder finans, og gi alle muligheten til å lære seg mer om mulighetene med innholdet vårt. Det har aldri vært viktigere å kunne ta kontroll over sine økonomiske beslutninger, og FD Akademi, sammen med Fonder Direkt, vil gi den informasjonen du trenger for å gjøre dette.</strong></p><p><strong>FD Akademi er en helt uavhengig tjeneste som inngår i Fonder Direkt, som igjen er en del av Nyhetsbyrån Direkt.</strong></p></React.Fragment>
                    }
                    <hr />
                    {tags && tags.length ? (
                    <div>
                        ...
                        <div className="tags">
                          {tags.map(tag => (
                            <Link key={tag + `tag`} to={`/tagger/${kebabCase(tag)}/`} className="tag is-medium is-link">{tag}</Link>
                          ))}
                        </div>
                    </div>
                    ) : null}
                    <div className="share">
                      ...
                      <OutboundLink href={'https://twitter.com/share?url=' + encodeURIComponent(shareUrl) + '&text=' + encodeURIComponent(title)} className="is-twitter is-share" target="_blank" rel="noopener noreferrer">
                      ...
                      <OutboundLink href={'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(shareUrl) + '&t=' + encodeURIComponent(title)} className="is-facebook is-share" target="_blank" rel="noopener noreferrer">
                      ...
                      <OutboundLink href={'https://www.linkedin.com/shareArticle?url=' + encodeURIComponent(shareUrl) + '&mini=true&title=' + encodeURIComponent(title)}  className="is-linkedin is-share" target="_blank" rel="noopener noreferrer">
      ...
      <EducationPostTemplate
        ...
        helmet={
            <Helmet>
              ...
              <meta property="og:url" content={`https://fonderdirekt.no${post.fields.slug}`} />
