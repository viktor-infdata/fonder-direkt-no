            ...
            <div className="column is-8">
              <h5 className="is-size-6 mb-2 has-text-grey">
                ...
                {soundCloudId != null &&
                  <React.Fragment>
                    <hr />
                    <h5 className="is-size-5">Denne videoen finnes også som podcast</h5>
                ...
                <hr />
                <p><strong>Oppdragsvideo: Filmes og produseres av Fonder Direkt TV, en frittstående avdeling av Nyhetsbyrån Direkt AB.</strong></p>
                <hr />
                {tags && tags.length ? (
                <div>
                    <h4>TAGGER</h4>
