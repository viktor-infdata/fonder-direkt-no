  ...
  <Layout>
    <section className="section">
      <Helmet 
        title={`Tagger | ${title}`} 
      >
        <meta name="description" content="Utforsk taggede nyheter på Fonder Direkt, en plattform hvor du kan finne informasjon, lese nyheter og delta i kommunikasjon om fond." />
        <meta property="og:description" content="Utforsk taggede nyheter på Fonder Direkt, en plattform hvor du kan finne informasjon, lese nyheter og delta i kommunikasjon om fond." />
