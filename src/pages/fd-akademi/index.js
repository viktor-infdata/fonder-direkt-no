      ...
      <Layout>
        <section className="hero is-light">
          <Helmet title="FD Akademi | Fonder Direkt">
            <meta
              name="description"
              content="Seneste utdanningsmateriale fra Fonder Direkt, en plattform hvor du kan finne informasjon, lese nyheter og ta del i kommunikasjon om fond."
            />
            <meta property="og:title" content="FD Akademi | Fonder Direkt" />
            <meta
              property="og:url"
              content="https://fonderdirekt.no/fd-akademi/"
            />
            <meta
