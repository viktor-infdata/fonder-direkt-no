      ...
      <Layout>
        <section className="section">
          <Helmet title="Nyheter | Fonder Direkt">
            <meta
              name="description"
              content="Seneste nyheter fra Fonder Direkt, en plattform hvor du kan finne informasjon, lese nyheter og delta i kommunikasjon om fond."
            />
            <meta property="og:title" content="Nyheter | Fonder Direkt" />
            <meta
              property="og:url"
              content="https://fonderdirekt.no/nyheter/"
            />
            <meta
